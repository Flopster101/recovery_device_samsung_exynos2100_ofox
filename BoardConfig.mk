...
TARGET_PREBUILT_KERNEL := $(KERNEL_PREBUILT_PATH)/$(BOARD_KERNEL_IMAGE_NAME)
BOARD_INCLUDE_RECOVERY_DTBO := true
BOARD_PREBUILT_DTBOIMAGE := $(KERNEL_PREBUILT_PATH)/dtbo/$(PRODUCT_DEVICE)/dtbo.img
